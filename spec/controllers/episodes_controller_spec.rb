  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved episode as @episode" do
        ...
        post :create, {:episode => { "show" => "invalid value" }}, valid_session
        assigns(:episode).should be_a_new(Episode)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested episode" do
        ...
        Episode.any_instance.should_receive(:update_attributes).with({ "show" => "" })
        put :update, {:id => episode.to_param, :episode => { "show" => "" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the episode as @episode" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Episode.any_instance.stub(:save).and_return(false)
        put :update, {:id => episode.to_param, :episode => { "show" => "invalid value" }}, valid_session
        assigns(:episode).should eq(episode)
      end
